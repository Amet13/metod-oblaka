\section{Пример деплоя приложения на Heroku} \label{pril:e}
...
\begin{figure}[ht]
    \centering
	\includegraphics[width=0.6\linewidth]{createapp}
...
Обновляем страницу с приложением (рис.~\ref{pic:helloivt}).
\begin{figure}[ht]
    \centering
	\includegraphics[width=\linewidth]{newhello}
    \caption{Изменения в приложении вступили в силу}\label{pic:helloivt}
\end{figure}
