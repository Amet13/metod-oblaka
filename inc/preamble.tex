...
\hypersetup{
    ...
    pdftitle={Cloud computing and GRID},
}

%%% Изображения %%%
\usepackage[dvipdfm]{graphicx}		% Подключаем пакет работы с графикой
\graphicspath{{images/}{images/install_vb/}{images/install_debian/}{images/owncloud-server/}{images/owncloud-client/}}	% Пути к изображениям
