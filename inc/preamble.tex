...
\hypersetup{
    ...
    pdfproducer={https://github.com/Amet13/metod-oblaka},
    pdftitle={Cloud computing}
}

%%% Изображения %%%
\usepackage[dvipdfm]{graphicx}		% Подключаем пакет работы с графикой
\graphicspath{{images/}{images/install_vb/}{images/install_debian/}{images/owncloud-server/}{images/owncloud-client/}{images/heroku/}{images/openstack/}}	% Пути к изображениям
...
\renewcommand{\@oddhead}{\it \vbox{\hbox to \textwidth%
    {\rm{\thepage \hfil \Sectionname}\strut}\hrule}}
\makeatother
